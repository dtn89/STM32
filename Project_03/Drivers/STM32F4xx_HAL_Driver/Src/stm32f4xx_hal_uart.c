  ...
  [..]
     ...
     *** Interrupt mode IO operation ***
     ...
     [..]
       ...
       (+) At reception end of transfer HAL_UART_ is executed and user can
            add his own code by customization of function pointer HAL_UART_
 ...
 ===============================================================================
    ...
    (#) There are two modes of transfer:
       ...
       (+) Non-Blocking mode: The communication is performed using Interrupts
           ...
           using DMA mode.
           The HAL_UART_TxCpltCallback(), HAL_UART_() user callbacks
